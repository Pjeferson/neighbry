...
ActiveRecord::Schema[8.1].define(version: 2026_05_23_200000) do
  ...
  create_table "approvals", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.text "user_agent"
    t.index ["payment_order_id", "approver_id"], name: "uq_approval_per_approver", unique: true
    t.index ["payment_order_id", "decision"], name: "idx_approvals_order"
    t.index ["payment_order_id"], name: "index_approvals_on_payment_order_id"
  end
  ...
  create_table "payment_orders", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["expires_at"], name: "idx_orders_expires", where: "((status)::text = 'pending_approval'::text)"
    t.index ["idempotency_key"], name: "index_payment_orders_on_idempotency_key", unique: true
  end
  ...
  add_foreign_key "approvals", "payment_orders"
